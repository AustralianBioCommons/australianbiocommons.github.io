    ...
    def convert_tool_to_yaml(tool):
        ...
        if tool.get(Dataprovider.FIELD_NAMES.INCLUSION) == True:
            return {
                ...
                "description": tool.get(Dataprovider.FIELD_NAMES.DESCRIPTION, None),
                "name": tool[Dataprovider.FIELD_NAMES.NAME],
                "homepage": tool[Dataprovider.FIELD_NAMES.REPOSITORY_URL] if not pd.isna(tool[Dataprovider.FIELD_NAMES.REPOSITORY_URL]) else None,
                "biotools": tool.get(Dataprovider.FIELD_NAMES.BIOTOOLS_ID, None),
                ...
                "edam-topics": [i["term"] for i in tool[Dataprovider.FIELD_NAMES.EDAM_TOPICS]] if isinstance(tool[Dataprovider.FIELD_NAMES.EDAM_TOPICS], list) else None,
                ...
                "edam-operations": [i["term"] for i in tool[Dataprovider.FIELD_NAMES.EDAM_OPERATIONS]] if Dataprovider.FIELD_NAMES.EDAM_OPERATIONS in tool and isinstance(tool[Dataprovider.FIELD_NAMES.EDAM_OPERATIONS], list) else None,
                "edam-inputs": [get_edam_data(i) for i in tool[Dataprovider.FIELD_NAMES.EDAM_DATA_INPUT]] if Dataprovider.FIELD_NAMES.EDAM_DATA_INPUT in tool and isinstance(tool[Dataprovider.FIELD_NAMES.EDAM_DATA_INPUT], list) else None,
                "edam-outputs": [get_edam_data(i) for i in tool[Dataprovider.FIELD_NAMES.EDAM_DATA_OUTPUT]] if Dataprovider.FIELD_NAMES.EDAM_DATA_OUTPUT in tool and isinstance(tool[Dataprovider.FIELD_NAMES.EDAM_DATA_OUTPUT], list) else None,
                "publications": [translate_publication(i) for i in tool[Dataprovider.FIELD_NAMES.PUBLICATIONS]] if Dataprovider.FIELD_NAMES.PUBLICATIONS in tool and isinstance(tool[Dataprovider.FIELD_NAMES.PUBLICATIONS],list) else None,
                "biocontainers": tool.get(Dataprovider.FIELD_NAMES.BIOCONTAINERS_LINK, None),
                "license": tool.get(Dataprovider.FIELD_NAMES.LICENSE, None),
                "resources": [translate_biocommons_resources(tool.get(Dataprovider.FIELD_NAMES.BIOCOMMONS_DOCUMENTATION_LINK, ""), tool.get(Dataprovider.FIELD_NAMES.BIOCOMMONS_DOCUMENTATION_DESCRIPTION, None))],
                "galaxy": [translate_galaxy(i) for i in tool[Dataprovider.FIELD_NAMES.GALAXY_AUSTRALIA_LAUNCH_LINK]] if Dataprovider.FIELD_NAMES.GALAXY_AUSTRALIA_LAUNCH_LINK in tool and isinstance(tool[Dataprovider.FIELD_NAMES.GALAXY_AUSTRALIA_LAUNCH_LINK],list) else None,
                "nci-gadi": [i for i in tool[Dataprovider.FIELD_NAMES.NCI_GADI_VERSION]] if Dataprovider.FIELD_NAMES.NCI_GADI_VERSION in tool and isinstance(tool[Dataprovider.FIELD_NAMES.NCI_GADI_VERSION], list) else None,
                "nci-if89": [i for i in tool[Dataprovider.FIELD_NAMES.NCI_IF89_VERSION]] if Dataprovider.FIELD_NAMES.NCI_IF89_VERSION in tool and isinstance(tool[Dataprovider.FIELD_NAMES.NCI_IF89_VERSION], list) else None,
                "pawsey": [i for i in tool[Dataprovider.FIELD_NAMES.PAWSEY_SETONIX_VERSION]] if Dataprovider.FIELD_NAMES.PAWSEY_SETONIX_VERSION in tool and isinstance(tool[Dataprovider.FIELD_NAMES.PAWSEY_SETONIX_VERSION], list) else None,
                "bunya": [i for i in tool[Dataprovider.FIELD_NAMES.QRISCLOUD_VERSION]] if Dataprovider.FIELD_NAMES.QRISCLOUD_VERSION in tool and isinstance(tool[Dataprovider.FIELD_NAMES.QRISCLOUD_VERSION], list) else None,
            }
