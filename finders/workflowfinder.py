...
class WorkflowDB(DB):
    ...
    def get_formatted_table(self):
        ...
        for index, row in workflow_table.iterrows():
            ...
            <a href="%s" ga-product="github" ga-id="%s"><img src="https://github.com/AustralianBioCommons/australianbiocommons.github.io/blob/master/images/GitHub-Mark-64px.png"></a>""" % (row[Dataprovider.FIELD_NAMES.URL], row[Dataprovider.FIELD_NAMES.URL],
