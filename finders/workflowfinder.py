...
class WorkflowDB(DB):
    ...
    def get_formatted_table(self):
        ...
        for index, row in workflow_table.iterrows():
            ...
            <a href="%s" ga-product="github" ga-id="%s"><img src="https://github.com/AustralianBioCommons/australianbiocommons.github.io/blob/0e9b978162f0393c2220bd2a4f5048db1e1ef388/images/GitHub-Mark-64px.png"></a>""" % (row[Dataprovider.FIELD_NAMES.URL], row[Dataprovider.FIELD_NAMES.URL],
