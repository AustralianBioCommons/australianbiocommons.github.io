...
This page lists bioinformatics tools installed across several of the [BioCommons infrastructure partner systems](./1_compute_systems.html) and tool installation request mechanisms on these systems. Tool status on other partner infrastructures will be added over time.
...
container1 = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th(class = 'dt-center', style="font-size:11pt", colspan = 8, 'Tool metadata'),
    ...
    tr(
      lapply(c("Tool / workflow name", "bio.tools documentation", "Tool identifier (module name / bio.tools ID / placeholder)",
               "Description", "EDAM topics", "Containers available? (BioContainers)", "License", "Available in Galaxy toolshed", 
               "Galaxy Australia", "NCI (Gadi)", "Pawsey (Zeus)", "Pawsey (Magnus)", 
