...
container2 = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th(class = 'dt-center', style="font-size:11pt", colspan = 6, 'Workflow information'),
      th(class = 'dt-center', style="font-size:11pt", colspan = 2, 'Citation & credits'),
      th(class = 'dt-center', style="font-size:11pt", colspan = 2, 'Deployment')
    ),
    tr(
      lapply(c("Workflow name (+ WorkflowHub link)","EDAM operation(s)","EDAM topic(s)","Tag(s)","License",
                "Updated at","DOI","Contributing team(s)","How-to-Guide","Launch workflow (if available)"), th)
    )
  )
))
