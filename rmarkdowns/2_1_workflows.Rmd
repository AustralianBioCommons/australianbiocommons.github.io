...
container2 = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th(class = 'dt-center', style="font-size:12pt", colspan = 6, 'Workflow information'),
    ...
    tr(
      lapply(c("Workflow name (+ links)","EDAM topic(s)","EDAM operation(s)","Tag(s)","License",
                "Updated","DOI","Contributing team(s)","User guide","Open workflow (if available)"), th, style="font-size:11pt")
    )
  )
))
  ...
  datatable(
    ...
    options = list(
      ...
      columnDefs = list(
                        ...
                        list(width = '200px', targets = c(0,3))
                        )
            ), 
