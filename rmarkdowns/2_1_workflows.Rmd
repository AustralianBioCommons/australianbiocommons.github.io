...
container2 = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th(class = 'dt-center', style="font-size:11pt", colspan = 10, 'Workflow metadata'),
      th(class = 'dt-center', style="font-size:11pt", colspan = 1, 'Deployment')
    ),
    tr(
      lapply(c("Workflow name (+ WorkflowHub link)","Description","DOI","License",
                "Updated at","Tag(s)", "Contributing team(s)","EDAM topic(s)",
                "EDAM operation(s)", "How-to-Guide", "Launch workflow (if available)"), th)
    )
  )
))
