...
The website and its contents are built using [python](https://www.python.org/), [pycharm](https://www.jetbrains.com/pycharm/), [R](https://www.r-project.org/) and the [tidyverse](https://www.tidyverse.org/) (dplyr *et al.*), with [references included](5_attributions.html), and additional attributions embedded in the Rmarkdown scripts.
