  ...
  thead(
    ...
    tr(
      lapply(c("Tool / workflow name", "bio.tools documentation", "Tool identifier (module name / bio.tools ID / placeholder)",
               "Description", "EDAM topics", "Publications", "Containers available? (BioContainers)", "License", "Available in Galaxy toolshed",
...
datatable(installs,
          ...
          options = list(
            ...
            columnDefs = list(list(visible=FALSE, targets = c(2,7)),
                              list(className = 'dt-center', targets = c(0:2, 5:14)))
            ), 
